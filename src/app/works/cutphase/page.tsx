// src/app/works/cutphase/page.tsx
import type { Metadata } from 'next'
import Link from 'next/link'
import Image from 'next/image'
import NavigationInternal from '@/components/NavigationInternal'
import CutPhaseLegalModals from '@/components/CutPhaseLegalModals'

export const metadata: Metadata = {
  title: 'CutPhase',
  description:
    'CutPhase by Appscend Labs — an all-in-one fitness toolkit designed to simplify nutrition, planning, and progress tracking.',
  alternates: { canonical: '/works/cutphase' },
  openGraph: {
    title: 'CutPhase • Appscend Labs',
    description:
      'An all-in-one fitness toolkit designed to simplify nutrition, planning, and progress tracking. Everything you need to stay consistent—without the overwhelm.',
    type: 'website',
    url: '/works/cutphase',
  },
}

export default function CutPhasePage() {
  // Provide your real App Store URL in .env as NEXT_PUBLIC_CUTPHASE_APPSTORE_URL
  const APP_STORE_URL = process.env.NEXT_PUBLIC_CUTPHASE_APPSTORE_URL || ''
      ...
      <main className="pt-16">
        ...
        <section className="bg-slate-50 py-16">
          <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            {/* Left: copy + CTAs */}
            <div>
              <h1 className="text-3xl text-primary md:text-5xl">CutPhase</h1>
              <p className="mt-4 text-lg text-muted-foreground">
                An all-in-one fitness toolkit designed to simplify nutrition, planning, and progress tracking.
                Everything you need to stay consistent—without the overwhelm.
              </p>
            ...
            <div className="space-y-6">
              ...
              <div className="relative aspect-[4/3] w-full overflow-hidden rounded-xl border bg-white shadow">
                <Image
                  src="/images/cutphase-cover.png"
                  alt="CutPhase preview"
                  fill
              ...
              <div className="flex items-center gap-4 rounded-xl border bg-white p-4 shadow-sm md:gap-6 md:p-6">
                <div className="shrink-0 overflow-hidden rounded-lg border">
                  <img
                    src={qrSrc}
                    alt="QR code to download CutPhase"
                    width={160}
                    height={160}
        ...
        <section className="py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-6 md:grid-cols-3">
              {[
                {
                  title: 'Meal Planning & Cook Mode',
                  desc: 'Access batch-prep guides with step-by-step recipes for your weekly meals.',
                },
                {
                  title: 'Daily Schedule & Tracking',
                  desc: 'Track your calories, protein, and macros with a personalized eating timeline.',
                },
                {
                  title: 'Smart Shopping Lists',
                  desc: 'Auto-generate grocery lists organized by category from your meal plans.',
                },
              ].map((f) => (
