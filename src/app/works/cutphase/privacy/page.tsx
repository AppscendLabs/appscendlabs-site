...
import PrivacyContent from '@/components/legal/cutphase/PrivacyContent'

export const metadata: Metadata = {
  title: 'Privacy Policy - CutPhase',
  description:
    'Privacy Policy for CutPhase by Appscend Labs. Learn how we collect, use, and protect your information.',
  alternates: { canonical: '/works/cutphase/privacy' },
  robots: {
    index: false,
    follow: false,
  },
...
export default function CutPhasePrivacyPage() {
  return (
